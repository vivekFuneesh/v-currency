...
### Possible flaw and experimentable extension: 
   ...
   - But if we equally allocate same p% to everyone and in each work then rat race will completely end. People will become more joyful, healthy. Communities will prosper. They will work according to their skills and interests.
   - This equal distribution is mostly suitable for public or govt. institutions and govt. contracted helpers. This should be experimented only after successful implementation of unequal model in which some extra necesaary profits
to be added so as to be oriented towards financial independence within a span of 20-25 years.
   - Atlast, equal pay for all occupations and works can be set which doesnot depend upon the revenue from services and products, given that minimum set of tasks completed. This is to be decided, say for eg. 20 years of service is mandatory and after 20 years, a person should have atleast x million HL. Accordingly HL can be printed and distributed or credited in digital wallets.
   - In this, people who save more and spend required will enjoy fruits later and their children will enjoy too. Those who gamble, lazy, pleasure oriented will not have such fruits.
   - That's why shaping a mind is the basic seed in this framework. Once a non-criminal person completes basic training and shows noble qualities in behaviour and thought-process tests, he becomes elligible for equal pay. Criminals to be kept on minimal pay with survelliance only.
   - We cannot control defilements, neither inside body nor outside but we can get rid of them by exhausting their conditions both inside human body and outside as well. But for outside to be successful, all involved beings have to rise up.

### Note : 
  - ***At international exchange level, profits inclusion is not required because of exchanges on the basis of production cost only. Extra profits then can be added by nation according to their own conversion ratios and profit policies. Livelihood standards may differ from country to country depending upon their interests, hence exchange to be done only on production cost between nations which will be rerouted tgrough the nation's respective conversion & profit-allocation portal.***
